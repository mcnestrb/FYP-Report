...
\part{Introduction}
\label{sec:org6e279e3}
\part{Background}
\label{sec:orgd3d22ae}
\chapter{Decentralised Grid}
\label{sec:orge8dc954}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:org3047615}
\section{Overview}
\label{sec:org1f5a629}
...
\chapter{Auctions}
\label{sec:orgeca5c5b}
\section{Overview}
\label{sec:org3e65339}
...
\chapter{Game Theory}
\label{sec:org9353d13}
\section{Overview}
\label{sec:org9dcaa47}
...
\label{sec:org664be40}
\section{Overview}
\label{sec:orge4f6fca}
...
\part{Implementation}
\label{sec:org55956bf}
\chapter{Design}
\label{sec:orgbc0de7b}
\chapter{Framework}
\label{sec:org0b3f063}
\chapter{Processes}
\label{sec:org566922c}
\part{Conclusion}
\label{sec:org52e75f5}
\chapter{Assessment}
\label{sec:orgd5f3ffd}
\chapter{Future Work and Continuations}
\label{sec:org209be06}
\printbibliography
\appendix
\end{document}