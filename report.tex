...
\part{Background}
\label{sec:orgc283c88}
\chapter{Decentralised Grid}
\label{sec:orgb60b4ba}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:org065e9b1}
\section{Overview}
\label{sec:org25f22da}
...
\chapter{Auctions}
\label{sec:orgcad059b}
\section{Overview}
\label{sec:org9f2cfef}
...
\chapter{Game Theory}
\label{sec:orgcc2348b}
\section{Overview}
\label{sec:org8d1e1ac}
...
\label{sec:orgdd5b0bb}
\section{Overview}
\label{sec:org098d086}
...
One of the components of the VI problem is that of a functional. A functional is
a function that maps a vector space onto its underlying field of scalars. Often
this vector space can be a series of functions, meaning that the functional
takes a function as an argument and can be interpreted as a function of
functions. This is similar to the Haskell idea of higher order functions, where
a single higher order function can be used to operate on multiple functions and
...
\part{Implementation}
\label{sec:org890a571}
\chapter{Design}
\label{sec:org882b441}
\section{Games vs Auctions}
\label{sec:org808c851}
...
\label{sec:org489367d}
\subsection{EC Utility Function}
\label{sec:org0a14c44}
...
\chapter{Application}
\label{sec:org553d69d}
\section{Python Twisted Framework}
\label{sec:org3e05aeb}
