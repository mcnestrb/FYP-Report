...
\part{Background}
\label{sec:org52d4638}
\chapter{Decentralised Grid}
\label{sec:orgbda8d13}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:orgd049e76}
\section{Overview}
\label{sec:org07a0162}
...
\chapter{Auctions}
\label{sec:orgeb4d1e9}
\section{Overview}
\label{sec:orgb79862b}
...
\chapter{Game Theory}
\label{sec:orga1cba59}
\section{Overview}
\label{sec:org1f81fd4}
...
\label{sec:orgb3b387f}
\section{Overview}
\label{sec:orgd24a194}
...
\part{Implementation}
\label{sec:orgc6c357c}
\chapter{Design}
\label{sec:org4530b49}
\section{Games vs Auctions}
\label{sec:org6617632}
...
\label{sec:org9f1bfd1}
\subsection{EC Utility Function}
\label{sec:orgdad145e}
...
\chapter{Application}
\label{sec:org61ecd09}
\section{Python Twisted Framework}
\label{sec:org527618e}
...
that time.
\section{Client (EC)}
\label{sec:org19460b1}
\subsection{Idle State}
\label{sec:org2cf23ca}
...
Solodov and Svaiter.
\section{Server (CPS)}
\label{sec:org9b07364}
\subsection{Idle State}
\label{sec:org25e109e}
...
\part{Conclusion}
\label{sec:org0825416}
\chapter{Results}
\label{sec:org3833915}
