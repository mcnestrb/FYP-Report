...
\part{Abstract}
\label{sec:orgab1cca8}
\part{Introduction}
\label{sec:orgb7f7e61}
\part{Background}
\label{sec:org724d5c1}
\chapter{Decentralised Grid}
\label{sec:org9dbb7fa}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:org42cf66e}
\section{Overview}
\label{sec:org36b09ec}
...
\label{sec:orgf3da2c4}
\chapter{Auctions}
\label{sec:org27a23cf}
\chapter{Game Theory}
\label{sec:orgd19d720}
\section{Overview}
\label{sec:orgb64b97d}
...
\label{sec:orgbaf30b6}
\section{Overview}
\label{sec:org466b878}
...
\part{Implementation}
\label{sec:orgd0ddb8c}
\chapter{Design}
\label{sec:org6242c89}
\chapter{Framework}
\label{sec:orgb372b2f}
\chapter{Processes}
\label{sec:orgc52d9f3}
\part{Conclusion}
\label{sec:orgd29d930}
\chapter{Assessment}
\label{sec:org9740f44}
\chapter{Future Work and Continuations}
\label{sec:orgca56f8b}
\printbibliography
\appendix
\end{document}