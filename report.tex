...
\part{Introduction}
\label{sec:orgbdb23f3}
\part{Background}
\label{sec:org829b536}
\chapter{Decentralised Grid}
\label{sec:org6cd4741}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:orgfb47eae}
\section{Overview}
\label{sec:org42e4c3e}
...
\chapter{Auctions}
\label{sec:org0b56656}
\section{Overview}
\label{sec:org9b0c256}
...
\chapter{Game Theory}
\label{sec:org60d88cc}
\section{Overview}
\label{sec:org964f563}
...
\label{sec:orga696861}
\section{Overview}
\label{sec:org6679534}
...
\part{Implementation}
\label{sec:org1ae919f}
\chapter{Design}
\label{sec:orga306a49}
\section{Games vs Auctions}
\label{sec:orgabe08f7}
...
\end{figure}
\section{Game Design}
\label{sec:org1553d0d}
\section{Utility Functions}
\label{sec:org45b0300}
\subsection{EC Utility Function}
\label{sec:orgb355df4}
\subsection{CPS Utility Function}
\label{sec:orgc47297e}
\chapter{Application}
\label{sec:orga518bb0}
\section{Python Twisted Framework}
\label{sec:org9e34347}
\section{Client (EC)}
\label{sec:org6f8b432}
\section{Server (CPS)}
\label{sec:org06e5ebb}
\part{Conclusion}
\label{sec:org3dea0b6}
\chapter{Results}
\label{sec:org81ae428}
\chapter{Assessment}
\label{sec:orga6cf3a9}
\chapter{Future Work and Continuations}
\label{sec:org7184421}
\printbibliography
\appendix
\end{document}