...
\part{Introduction}
\label{sec:org8d63042}
\part{Background}
\label{sec:org4f50280}
\chapter{Decentralised Grid}
\label{sec:orgfd14166}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:org9087449}
\section{Overview}
\label{sec:orgc82a183}
...
\chapter{Auctions}
\label{sec:org61c75b3}
\section{Overview}
\label{sec:org150830e}
...
double auction. 
\section{}
\label{sec:org3ff134e}
\chapter{Game Theory}
\label{sec:orgc255e10}
\section{Overview}
\label{sec:org8564089}
...
\label{sec:orgb9cdec6}
\section{Overview}
\label{sec:orgc0773c3}
...
\part{Implementation}
\label{sec:org5864868}
\chapter{Design}
\label{sec:org975c551}
\chapter{Framework}
\label{sec:org6080512}
\chapter{Processes}
\label{sec:orge7208b1}
\part{Conclusion}
\label{sec:orgecc4191}
\chapter{Assessment}
\label{sec:org8132132}
\chapter{Future Work and Continuations}
\label{sec:org0261825}
\printbibliography
\appendix
\end{document}