...
\part{Background}
\label{sec:orgabcd2d2}
\chapter{Decentralised Grid}
\label{sec:org55a3076}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:orge657277}
\section{Overview}
\label{sec:orgad70b0a}
...
\chapter{Auctions}
\label{sec:org12af8c0}
\section{Overview}
\label{sec:orgc9e625f}
...
\chapter{Game Theory}
\label{sec:org29ef764}
\section{Overview}
\label{sec:org687ccd6}
...
\label{sec:orge915e93}
\section{Overview}
\label{sec:orgff6caed}
...
\part{Implementation}
\label{sec:orgf76fd1c}
\chapter{Design}
\label{sec:orgafa5cb8}
\section{Games vs Auctions}
\label{sec:orgc9e871f}
...
\label{sec:org3739141}
\subsection{EC Utility Function}
\label{sec:org99a1b77}
...
\chapter{Application}
\label{sec:org836d9c2}
\section{Python Twisted Framework}
\label{sec:org27a63d0}
...
that time.
\section{Client (EC)}
\label{sec:orgd749dd4}
\subsection{Idle State}
\label{sec:org539f024}
...
Solodov and Svaiter.
\section{Server (CPS)}
\label{sec:org2a11dfc}
\subsection{Idle State}
\label{sec:orgc9a9fc0}
...
\part{Conclusion}
\label{sec:org1d20713}
\chapter{Results}
\label{sec:orga78f043}
