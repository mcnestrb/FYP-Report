...
\part{Abstract}
\label{sec:org37b2f36}
\part{Introduction}
\label{sec:org2ebffcd}
\part{Background}
\label{sec:orgf5d57dc}
\chapter{Decentralised Grid}
\label{sec:org6b20feb}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:org3b14a09}
\section{Overview}
\label{sec:org2df7c92}
...
\label{sec:org867356c}
\chapter{Auctions}
\label{sec:org706b282}
\chapter{Game Theory}
\label{sec:org1ea7f2b}
\section{Overview}
\label{sec:org3afffb8}
...
\label{sec:orgf817f66}
\section{Overview}
\label{sec:org267bfb1}
...
\label{sec:orgdc1564b}
\section{Hyperplane Projection}
\label{sec:org6ce20c3}
\part{Implementation}
\label{sec:org28b8c9b}
\chapter{Design}
\label{sec:org6fe1645}
\chapter{Framework}
\label{sec:org75d258f}
\chapter{Processes}
\label{sec:org070097f}
\part{Conclusion}
\label{sec:org25497d6}
\chapter{Assessment}
\label{sec:orgded2f1a}
\chapter{Future Work and Continuations}
\label{sec:org4df4b21}
\printbibliography
\appendix
\end{document}