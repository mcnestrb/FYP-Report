...
\part{Background}
\label{sec:orga3778bb}
\chapter{Decentralised Grid}
\label{sec:org10ba276}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:orgab062cd}
\section{Overview}
\label{sec:orgf200cf6}
...
\chapter{Auctions}
\label{sec:org7ee5450}
\section{Overview}
\label{sec:orgda6684a}
...
\chapter{Game Theory}
\label{sec:org57aff0e}
\section{Overview}
\label{sec:org56048e1}
...
\label{sec:orgb950c6f}
\section{Overview}
\label{sec:org0a534eb}
...
\part{Implementation}
\label{sec:org4672f6c}
\chapter{Design}
\label{sec:orgbe063fe}
\section{Games vs Auctions}
\label{sec:orgbf187d9}
...
\label{sec:org5d941a8}
\subsection{EC Utility Function}
\label{sec:orgaac7659}
...
\chapter{Application}
\label{sec:orgf502152}
\section{Python Twisted Framework}
\label{sec:orga0addd6}
...
that time.
\section{Client (EC)}
\label{sec:org4801596}
\subsection{Idle State}
\label{sec:org4077836}
...
Solodov and Svaiter.
\section{Server (CPS)}
\label{sec:orge1fb8fd}
\subsection{Idle State}
\label{sec:org8bcd730}
...
\part{Conclusion}
\label{sec:orgd925b6d}
\chapter{Results}
\label{sec:org90ee71b}
