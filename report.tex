...
\part{Introduction}
\label{sec:orgfc12d28}
\part{Background}
\label{sec:org2af603d}
\chapter{Decentralised Grid}
\label{sec:org03a6d13}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:org656e697}
\section{Overview}
\label{sec:org27e83de}
...
\chapter{Auctions}
\label{sec:org526d910}
\section{Overview}
\label{sec:orga7a216c}
...
\chapter{Game Theory}
\label{sec:orge75e592}
\section{Overview}
\label{sec:orgd0ae559}
...
\label{sec:org0df02af}
\section{Overview}
\label{sec:org071001d}
...
\part{Implementation}
\label{sec:org63d10e7}
\chapter{Design}
\label{sec:orgbdd2bdf}
\section{Games vs Auctions}
\label{sec:orga61047f}
...
\label{sec:org61d39b2}
\subsection{EC Utility Function}
\label{sec:org03f54a7}
...
\chapter{Application}
\label{sec:org037ab8f}
\section{Python Twisted Framework}
\label{sec:orgb5dae81}
...
that time.
\section{Client (EC)}
\label{sec:org202c28d}
\subsection{Idle State}
\label{sec:org4412224}
...
Solodov and Svaiter.
\section{Server (CPS)}
\label{sec:org39e1a16}
\subsection{Idle State}
\label{sec:org9565e10}
...
\part{Conclusion}
\label{sec:orgf9f4e65}
\chapter{Results}
\label{sec:org3bdf707}
\chapter{Assessment}
\label{sec:orgf3e2691}
\chapter{Future Work and Continuations}
\label{sec:org67c92a0}
\printbibliography
\appendix
\end{document}