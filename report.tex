...
\part{Introduction}
\label{sec:org4959d70}
\part{Background}
\label{sec:orgba0fc27}
\chapter{Decentralised Grid}
\label{sec:orgf709244}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:org2140887}
\section{Overview}
\label{sec:org4fb3fde}
...
\chapter{Auctions}
\label{sec:org71d8949}
\section{Overview}
\label{sec:orgcc041cc}
...
\chapter{Game Theory}
\label{sec:org9317b6a}
\section{Overview}
\label{sec:org794756c}
...
\label{sec:org274de7e}
\section{Overview}
\label{sec:org0993e67}
...
\part{Implementation}
\label{sec:orgbe3a7b7}
\chapter{Design}
\label{sec:org4157e31}
\section{Games vs Auctions}
\label{sec:orga03b35c}
...
energy into the grid. Each Energy Consumer (EC) then notifies the CPS as to whether it is in need
of energy or whether it has energy to sell and if it's the case of the former
then it also sends how much energy it requires.
...
number of suppliers within the system to each Energy Supplier (ES). Each ES
first calculates how much energy it can be offered by dividing the total price
by the number of players. Each one then uses the SSHPM optimisation method to
determine an estimate for the energy it is willing to give to the CPS at that
price and sends that estimate to the CPS.


\section{Game Design}
\label{sec:org4519dc1}
\section{Utility Functions}
\label{sec:orgbe3487d}
\subsection{EC Utility Function}
\label{sec:org687629a}
\subsection{CPS Utility Function}
\label{sec:orgfb7b174}
\chapter{Application}
\label{sec:orgd9540cd}
\section{Python Twisted Framework}
\label{sec:orgbdf452d}
\section{Client (EC)}
\label{sec:org06dc46b}
\section{Server (CPS)}
\label{sec:org61b395d}
\part{Conclusion}
\label{sec:org36b7010}
\chapter{Results}
\label{sec:org7f66bb4}
\chapter{Assessment}
\label{sec:orgb46ee24}
\chapter{Future Work and Continuations}
\label{sec:org2ff3de2}
\printbibliography
\appendix
\end{document}