...
\part{Introduction}
\label{sec:orgad83c13}
\part{Background}
\label{sec:orgdb2a657}
\chapter{Decentralised Grid}
\label{sec:org440a52e}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:orgcdf462b}
\section{Overview}
\label{sec:orgbf4494d}
...
\chapter{Auctions}
\label{sec:org17d23a4}
\section{Overview}
\label{sec:org755f540}
...
\chapter{Game Theory}
\label{sec:orgc5bae99}
\section{Overview}
\label{sec:orgda03129}
...
\label{sec:org1b125ae}
\section{Overview}
\label{sec:org3218191}
...
\part{Implementation}
\label{sec:orgba1bfa5}
\chapter{Design}
\label{sec:org4eae03f}
\section{Games vs Auctions}
\label{sec:org6fcd044}
...
\label{sec:org7b3f88c}
\subsection{EC Utility Function}
\label{sec:org0369e76}
...
\chapter{Application}
\label{sec:orgce20064}
\section{Python Twisted Framework}
\label{sec:orgf50baab}
\section{Client (EC)}
\label{sec:org1ff200d}
\section{Server (CPS)}
\label{sec:orgb6cbe98}
\part{Conclusion}
\label{sec:org655dd53}
\chapter{Results}
\label{sec:orgdfb9fee}
\chapter{Assessment}
\label{sec:orgdb5c8d1}
\chapter{Future Work and Continuations}
\label{sec:org04ba7d0}
