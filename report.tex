...
\part{Background}
\label{sec:org129c0ae}
\chapter{Decentralised Grid}
\label{sec:org3a552b3}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:orga02a7b6}
\section{Overview}
\label{sec:org11bb4e2}
...
\chapter{Auctions}
\label{sec:org090bb9a}
\section{Overview}
\label{sec:org71a375a}
...
\chapter{Game Theory}
\label{sec:org9fc9a8a}
\section{Overview}
\label{sec:org263e5f0}
...
\label{sec:org5bd384d}
\section{Overview}
\label{sec:orgae444c0}
...
\part{Implementation}
\label{sec:org1dd7358}
\chapter{Design}
\label{sec:orgc97bc93}
\section{Games vs Auctions}
\label{sec:orgbbd6cb8}
...
\label{sec:org8e92198}
\subsection{EC Utility Function}
\label{sec:org2565879}
...
\chapter{Application}
\label{sec:org32971ed}
\section{Python Twisted Framework}
\label{sec:orgd9b967f}
...
that time.
\section{Client (EC)}
\label{sec:org05f725c}
\subsection{Idle State}
\label{sec:org8be0cce}
...
Solodov and Svaiter.
\section{Server (CPS)}
\label{sec:orgcc32cab}
\subsection{Idle State}
\label{sec:org950dcbe}
...
\part{Conclusion}
\label{sec:orgb14889d}
\chapter{Results}
\label{sec:orgc56aa81}
