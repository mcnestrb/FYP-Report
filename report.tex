...
\part{Background}
\label{sec:org4f08f28}
\chapter{Decentralised Grid}
\label{sec:org6725255}
...
\chapter{Auctions}
\label{sec:orge64c36c}
\section{Overview}
\label{sec:org6067945}
...
\chapter{Game Theory}
\label{sec:org4b5465b}
\section{Overview}
\label{sec:orge5c7b6b}
...
\label{sec:orgdf40977}
\section{Overview}
\label{sec:org5b19aac}
...
\part{Implementation}
\label{sec:org213c7d9}
\chapter{Design}
\label{sec:orge6bf736}
\section{Games vs Auctions}
\label{sec:orgcbf9a82}
...
\label{sec:org614cb46}
\subsection{EC Utility Function}
\label{sec:org3f24240}
...
\chapter{Application}
\label{sec:orga6d81f0}
\section{Python Twisted Framework}
\label{sec:org02b6a8f}
...
that time.
\section{Client (EC)}
\label{sec:orgc00effc}
\subsection{Idle State}
\label{sec:org881fe70}
...
Solodov and Svaiter.
\section{Server (CPS)}
\label{sec:orge5eb09b}
\subsection{Idle State}
\label{sec:orgf1a42aa}
...
\part{Conclusion}
\label{sec:org50a77c9}
\chapter{Results}
\label{sec:orgb7c7c97}
