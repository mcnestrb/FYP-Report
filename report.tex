...
\part{Background}
\label{sec:orgd65376b}
\chapter{Decentralised Grid}
\label{sec:org2c38c38}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:org1694022}
\section{Overview}
\label{sec:org9355f0b}
...
\chapter{Auctions}
\label{sec:org08f12f3}
\section{Overview}
\label{sec:org0d1151c}
...
\chapter{Game Theory}
\label{sec:org768f811}
\section{Overview}
\label{sec:org1f37ce2}
...
\label{sec:org6a778f9}
\section{Overview}
\label{sec:org7a401f9}
...
\part{Implementation}
\label{sec:org626a0ac}
\chapter{Design}
\label{sec:org8f9847e}
\section{Games vs Auctions}
\label{sec:org565a281}
...
\label{sec:orgcb86038}
\subsection{EC Utility Function}
\label{sec:org272b87c}
...
\chapter{Application}
\label{sec:org5fe4f34}
\section{Python Twisted Framework}
\label{sec:org3005778}
...
that time.
\section{Client (EC)}
\label{sec:org74b51b3}
\subsection{Idle State}
\label{sec:org666f608}
...
Solodov and Svaiter.
\section{Server (CPS)}
\label{sec:orga88752f}
\subsection{Idle State}
\label{sec:org051e58a}
...
\part{Conclusion}
\label{sec:orga7340f1}
\chapter{Results}
\label{sec:org4ec81a4}
\chapter{Assessment}
\label{sec:org4ca6743}
stuff about how this would require a refit scheme first to ensure growth
A few years down the line
Did it work?

\chapter{Future Work and Continuations}
\label{sec:orgbfc1a21}
