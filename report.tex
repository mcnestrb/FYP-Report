...
\part{Introduction}
\label{sec:org73a3d2e}
\part{Background}
\label{sec:org2f713d9}
\chapter{Decentralised Grid}
\label{sec:orgcf9b68a}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:org5afceb9}
\section{Overview}
\label{sec:org7f01728}
...
\chapter{Auctions}
\label{sec:org06ca889}
\section{Overview}
\label{sec:org71bd3c9}
...
\chapter{Game Theory}
\label{sec:org54ede61}
\section{Overview}
\label{sec:org05e1a04}
...
\label{sec:org309af37}
\section{Overview}
\label{sec:org8d13e51}
...
\part{Implementation}
\label{sec:org26db528}
\chapter{Design}
\label{sec:org954bb00}
\section{Games vs Auctions}
\label{sec:org770f534}
...
\label{sec:org3ac6f97}
\section{Game Design}
\label{sec:org49154eb}
\chapter{Application}
\label{sec:org46e6544}
\section{Python Twisted Framework}
\label{sec:orgdc9ffa0}
\section{Client (EC)}
\label{sec:orge14f1ca}
\section{Server (CPS)}
\label{sec:org9c74453}
\part{Conclusion}
\label{sec:org3cc79d3}
\chapter{Results}
\label{sec:org4ec71f2}
\chapter{Assessment}
\label{sec:org47c5c64}
\chapter{Future Work and Continuations}
\label{sec:org64b39d7}
\printbibliography
\appendix
\end{document}