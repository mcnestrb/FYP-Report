...
\part{Background}
\label{sec:orgb856a71}
\chapter{Decentralised Grid}
\label{sec:orgcd4d6de}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:orgf67a372}
\section{Overview}
\label{sec:orge459297}
...
\chapter{Auctions}
\label{sec:org15ede3d}
\section{Overview}
\label{sec:org4aac5e7}
...
\chapter{Game Theory}
\label{sec:org26b4041}
\section{Overview}
\label{sec:orgb50d981}
...
\label{sec:orga44c2ed}
\section{Overview}
\label{sec:org9e1a2d9}
...
\part{Implementation}
\label{sec:orgacf04d5}
\chapter{Design}
\label{sec:orgac598c7}
\section{Games vs Auctions}
\label{sec:orgf4b196c}
...
\label{sec:org3f1f3ea}
\subsection{EC Utility Function}
\label{sec:orgf7ab011}
...
\chapter{Application}
\label{sec:org50b8a5a}
\section{Python Twisted Framework}
\label{sec:org27a55d5}
...
that time.
\section{Client (EC)}
\label{sec:org754f15e}
\subsection{Idle State}
\label{sec:orgcfdaa95}
...
Solodov and Svaiter.
\section{Server (CPS)}
\label{sec:orgd207a59}
\subsection{Idle State}
\label{sec:org5db7976}
...
\part{Conclusion}
\label{sec:org6a8fceb}
\chapter{Assessment}
\label{sec:org23eda46}
