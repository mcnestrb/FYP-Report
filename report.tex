...
\part{Background}
\label{sec:orgb5c9be3}
\chapter{Decentralised Grid}
\label{sec:org69dd36b}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:orgfd901cd}
\section{Overview}
\label{sec:org46ed767}
...
\chapter{Auctions}
\label{sec:org8b66dc7}
\section{Overview}
\label{sec:org05c9e7c}
...
\chapter{Game Theory}
\label{sec:orgd38e4f8}
\section{Overview}
\label{sec:org7704bdb}
...
\label{sec:org11727fa}
\section{Overview}
\label{sec:org6bee8ff}
...
\part{Implementation}
\label{sec:org6bb4c08}
\chapter{Design}
\label{sec:org8b35c2d}
\section{Games vs Auctions}
\label{sec:org9304326}
...
\label{sec:org785c185}
\subsection{EC Utility Function}
\label{sec:orga614e3f}
...
\chapter{Application}
\label{sec:orgfb01391}
\section{Python Twisted Framework}
\label{sec:orgccb8426}
...
that time.
\section{Client (EC)}
\label{sec:org99dfc1c}
\subsection{Idle State}
\label{sec:org0fdab16}
...
Solodov and Svaiter.
\section{Server (CPS)}
\label{sec:orgf9fe27d}
\subsection{Idle State}
\label{sec:org3ccb629}
...
\part{Conclusion}
\label{sec:org5054eb7}
\chapter{Results}
\label{sec:org9d03b32}
