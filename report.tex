...
\part{Background}
\label{sec:org8e0c522}
\chapter{Decentralised Grid}
\label{sec:org3694033}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:org9272f6c}
\section{Overview}
\label{sec:org0023447}
...
\chapter{Auctions}
\label{sec:orgfb7ea77}
\section{Overview}
\label{sec:org59b30b5}
...
\chapter{Game Theory}
\label{sec:orgb71361a}
\section{Overview}
\label{sec:orga3c5d32}
...
\label{sec:orgdf9beae}
\section{Overview}
\label{sec:orge6e195a}
...
\part{Implementation}
\label{sec:org0d693ef}
\chapter{Design}
\label{sec:org1630312}
\section{Games vs Auctions}
\label{sec:org5b82648}
...
\label{sec:org4e2100a}
\subsection{EC Utility Function}
\label{sec:org4d9a536}
...
\chapter{Application}
\label{sec:org74d2f3c}
\section{Python Twisted Framework}
\label{sec:org03e6a5b}
...
that time.
\section{Client (EC)}
\label{sec:org7fae85c}
\subsection{Idle State}
\label{sec:org8822b9c}
...
Solodov and Svaiter.
\section{Server (CPS)}
\label{sec:org4725c35}
\subsection{Idle State}
\label{sec:orga872aff}
...
\part{Conclusion}
\label{sec:org2107532}
\chapter{Results}
\label{sec:org72a6028}
