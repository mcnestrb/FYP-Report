...
\part{Background}
\label{sec:orga866e94}
\chapter{Decentralised Grid}
\label{sec:orge685990}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:org9057a8b}
\section{Overview}
\label{sec:orgc450677}
...
\chapter{Auctions}
\label{sec:orgc8abc31}
\section{Overview}
\label{sec:org5773478}
...
\chapter{Game Theory}
\label{sec:org5af18d7}
\section{Overview}
\label{sec:org18bcf5c}
...
\label{sec:orga29a5d4}
\section{Overview}
\label{sec:org78df715}
...
\part{Implementation}
\label{sec:org11ede8f}
\chapter{Design}
\label{sec:orgc0e3ca1}
\section{Games vs Auctions}
\label{sec:org7dcffbb}
...
\label{sec:org741acfa}
\subsection{EC Utility Function}
\label{sec:org7cc1054}
...
\chapter{Application}
\label{sec:org4ed644d}
\section{Python Twisted Framework}
\label{sec:orgd70b209}
...
that time.
\section{Client (EC)}
\label{sec:org1e0d3c6}
\subsection{Idle State}
\label{sec:orgac5939a}
...
Solodov and Svaiter.
\section{Server (CPS)}
\label{sec:org03988fb}
\subsection{Idle State}
\label{sec:org83fe904}
...
\part{Conclusion}
\label{sec:orgcf9f9ae}
\chapter{Results}
\label{sec:org60d1020}
