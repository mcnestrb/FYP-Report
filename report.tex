...
\part{Introduction}
\label{sec:org9c80a6a}
\part{Background}
\label{sec:org0a09e70}
\chapter{Decentralised Grid}
\label{sec:orga3bc78e}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:orgbe23af8}
\section{Overview}
\label{sec:org31ed1f6}
...
\chapter{Auctions}
\label{sec:org0bb8890}
\section{Overview}
\label{sec:org26e5287}
...
\chapter{Game Theory}
\label{sec:orgfe8cc1b}
\section{Overview}
\label{sec:org40d6f50}
...
\label{sec:org5c431f1}
\section{Overview}
\label{sec:org85481a9}
...
\part{Implementation}
\label{sec:org14cd68d}
\chapter{Design}
\label{sec:org67a2007}
\section{Games vs Auctions}
\label{sec:orga6cb107}
...
\label{sec:org60c520e}
\subsection{EC Utility Function}
\label{sec:orgc18af2f}
...
\label{sec:orgaacf1cc}

\chapter{Application}
\label{sec:orga06c711}
\section{Python Twisted Framework}
\label{sec:org6afc7de}
\section{Client (EC)}
\label{sec:orgdd63fbd}
\section{Server (CPS)}
\label{sec:orgdcce7f6}
\part{Conclusion}
\label{sec:org907bbb3}
\chapter{Results}
\label{sec:orgbbbef81}
\chapter{Assessment}
\label{sec:orgb24717b}
\chapter{Future Work and Continuations}
\label{sec:org6026184}
