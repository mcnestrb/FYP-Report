...
\part{Background}
\label{sec:orgf1a409f}
\chapter{Decentralised Grid}
\label{sec:orgcfe2265}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:org6205c23}
\section{Overview}
\label{sec:org2237368}
...
\chapter{Auctions}
\label{sec:org9fb62a5}
\section{Overview}
\label{sec:orgadf245c}
...
\chapter{Game Theory}
\label{sec:org8f05935}
\section{Overview}
\label{sec:org847674a}
...
\label{sec:org8e8e4d7}
\section{Overview}
\label{sec:org0eace78}
...
\part{Implementation}
\label{sec:org7219402}
\chapter{Design}
\label{sec:org4b8f36d}
\section{Games vs Auctions}
\label{sec:orgbea1040}
...
\label{sec:orga59c609}
\subsection{EC Utility Function}
\label{sec:org57f1e23}
...
\chapter{Application}
\label{sec:org0bbb7f7}
\section{Python Twisted Framework}
\label{sec:org8b482b4}
...
that time.
\section{Client (EC)}
\label{sec:org41b6fdb}
\subsection{Idle State}
\label{sec:org73d1d9b}
...
Solodov and Svaiter.
\section{Server (CPS)}
\label{sec:org640087b}
\subsection{Idle State}
\label{sec:orge954930}
...
\part{Conclusion}
\label{sec:org51f47f2}
\chapter{Results}
\label{sec:org31f9f14}
