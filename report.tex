...
\part{Abstract}
\label{sec:org7a97edb}

\part{Introduction}
\label{sec:orgbccfede}


\part{Background}
\label{sec:org8b1b5ae}
\chapter{Decentralised Grid}
\label{sec:org845bbdd}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:org7002c6d}
\section{Overview}
\label{sec:org6031e43}
