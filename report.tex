...
\part{Background}
\label{sec:org128c45d}
\chapter{Decentralised Grid}
\label{sec:orgb5012ec}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:org244fe81}
\section{Overview}
\label{sec:orgea16dfc}
...
\chapter{Auctions}
\label{sec:orgff1b342}
\section{Overview}
\label{sec:org7840d05}
...
\chapter{Game Theory}
\label{sec:org0e72c3a}
\section{Overview}
\label{sec:org51437c4}
...
\label{sec:org55bd154}
\section{Overview}
\label{sec:orgc4c4da3}
...
\part{Implementation}
\label{sec:orgd025a83}
\chapter{Design}
\label{sec:org2286b95}
\section{Games vs Auctions}
\label{sec:org2eed16e}
...
\label{sec:org46004f7}
\subsection{EC Utility Function}
\label{sec:org67ba36d}
...
\chapter{Application}
\label{sec:orgc499479}
\section{Python Twisted Framework}
\label{sec:org6925d16}
...
that time.
\section{Client (EC)}
\label{sec:org3f9974a}
\subsection{Idle State}
\label{sec:orgc2e9bca}
...
Solodov and Svaiter.
\section{Server (CPS)}
\label{sec:orgdecf786}
\subsection{Idle State}
\label{sec:org75b3237}
...
\part{Conclusion}
\label{sec:org9ee95d2}
\chapter{Results}
\label{sec:orgba930f6}
