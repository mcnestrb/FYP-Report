...
\part{Introduction}
\label{sec:orgeb9e5c1}
\part{Background}
\label{sec:org079a5ee}
\chapter{Decentralised Grid}
\label{sec:orgba3ce4d}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:orge75220a}
\section{Overview}
\label{sec:orgac99e36}
...
\chapter{Auctions}
\label{sec:orgf8de840}
\section{Overview}
\label{sec:org640fffc}
...
\chapter{Game Theory}
\label{sec:orgcd92f85}
\section{Overview}
\label{sec:org3d39717}
...
\label{sec:org246cd95}
\section{Overview}
\label{sec:orgac531ac}
...
\part{Implementation}
\label{sec:org99f8b72}
\chapter{Design}
\label{sec:orgea3fde0}
\section{Games vs Auctions}
\label{sec:org35a991e}
...
\label{sec:orgc6ddc7f}
\subsection{EC Utility Function}
\label{sec:orgad17b5f}
...
\chapter{Application}
\label{sec:org454b877}
\section{Python Twisted Framework}
\label{sec:orgb6cb76b}
...
run. 
\section{Client (EC)}
\label{sec:orgb77c319}
\section{Server (CPS)}
\label{sec:org70f5bf5}
\part{Conclusion}
\label{sec:org4391b11}
\chapter{Results}
\label{sec:org88fb873}
\chapter{Assessment}
\label{sec:orgecb90a7}
\chapter{Future Work and Continuations}
\label{sec:org535282e}
