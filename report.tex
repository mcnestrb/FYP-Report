...
\part{Background}
\label{sec:orgb9c892f}
\chapter{Decentralised Grid}
\label{sec:org98bd4cf}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:org3fe4384}
\section{Overview}
\label{sec:orgd2ad085}
...
\chapter{Auctions}
\label{sec:org6fd662a}
\section{Overview}
\label{sec:org77d6c58}
...
\chapter{Game Theory}
\label{sec:orgba2679a}
\section{Overview}
\label{sec:org22b7c83}
...
\label{sec:org162b612}
\section{Overview}
\label{sec:org217c627}
...
\part{Implementation}
\label{sec:org9d2afcc}
\chapter{Design}
\label{sec:org6c1db56}
\section{Games vs Auctions}
\label{sec:org7fb8d6a}
...
\label{sec:org966db71}
\subsection{EC Utility Function}
\label{sec:org8f35ca3}
...
\chapter{Application}
\label{sec:org6268071}
\section{Python Twisted Framework}
\label{sec:org3cb09e8}
...
that time.
\section{Client (EC)}
\label{sec:org1ad07af}
\subsection{Idle State}
\label{sec:orgf0ca581}
...
Solodov and Svaiter.
\section{Server (CPS)}
\label{sec:org74ad4a6}
\subsection{Idle State}
\label{sec:org3032b1b}
...
\part{Conclusion}
\label{sec:orgb96e586}
\chapter{Results}
\label{sec:orgd41c03d}
