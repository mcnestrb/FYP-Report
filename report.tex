...
\part{Abstract}
\label{sec:org18029b9}
\part{Introduction}
\label{sec:org59ba5bf}
\part{Background}
\label{sec:org92fb910}
\chapter{Decentralised Grid}
\label{sec:orgb61ca1b}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:org0d6cf85}
\section{Overview}
\label{sec:orgb29ca78}
...
\chapter{Auctions}
\label{sec:orgcecd573}
\chapter{Game Theory}
\label{sec:orga0bc77c}
\section{Overview}
\label{sec:orgffd5bd6}
...
\label{sec:orged6b168}
\section{Overview}
\label{sec:orgf0ed6fa}
...
\part{Implementation}
\label{sec:orga1c722e}
\chapter{Design}
\label{sec:org40f71c1}
\chapter{Framework}
\label{sec:org78f8f37}
\chapter{Processes}
\label{sec:org2b5be76}
\part{Conclusion}
\label{sec:orgaf8748a}
\chapter{Assessment}
\label{sec:orgee2ff2e}
\chapter{Future Work and Continuations}
\label{sec:org3b6b91f}
\printbibliography
\appendix
\end{document}