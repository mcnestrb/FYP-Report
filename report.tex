...
\part{Abstract}
\label{sec:org71d44b6}
\part{Introduction}
\label{sec:org37cdb33}
\part{Background}
\label{sec:org9751a34}
\chapter{Decentralised Grid}
\label{sec:org7a848e7}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:org1b97ba9}
\section{Overview}
\label{sec:org3b181e6}
...
\label{sec:orgc0b0e21}
\chapter{Auctions}
\label{sec:org472f816}
\chapter{Game Theory}
\label{sec:org1229d2c}
\section{Overview}
\label{sec:org2fa179b}
...
\label{sec:org6015a3f}
\section{Overview}
\label{sec:org557aee6}
...
\label{sec:orgf36b1d8}
\part{Implementation}
\label{sec:orga983099}
\chapter{Design}
\label{sec:org9509a0c}
\chapter{Framework}
\label{sec:orgf3ca831}
\chapter{Processes}
\label{sec:org0e2159e}
\part{Conclusion}
\label{sec:org95b0a56}
\chapter{Assessment}
\label{sec:orgdaaa01e}
\chapter{Future Work and Continuations}
\label{sec:orgf68c085}
\printbibliography
\appendix
\end{document}