...
\part{Background}
\label{sec:org4ca6dc2}
\chapter{Decentralised Grid}
\label{sec:org11e0de4}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:org18eb0fb}
\section{Overview}
\label{sec:org406ea87}
...
\chapter{Auctions}
\label{sec:orgab6de8a}
\section{Overview}
\label{sec:org32a2707}
...
\chapter{Game Theory}
\label{sec:orge667f60}
\section{Overview}
\label{sec:org77f435c}
...
\label{sec:orgc38715e}
\section{Overview}
\label{sec:org6f20fd1}
...
\part{Implementation}
\label{sec:orgb328cdd}
\chapter{Design}
\label{sec:orge6811af}
\section{Games vs Auctions}
\label{sec:org774b479}
...
\label{sec:org0493092}
\subsection{EC Utility Function}
\label{sec:org5845a37}
...
\chapter{Application}
\label{sec:orgf0fcd7e}
\section{Python Twisted Framework}
\label{sec:orgcd57fe2}
...
that time.
\section{Client (EC)}
\label{sec:org952e9fc}
\subsection{Idle State}
\label{sec:org969cc3c}
...
Solodov and Svaiter.
\section{Server (CPS)}
\label{sec:orgfe9d66f}
\subsection{Idle State}
\label{sec:org081ac16}
...
\part{Conclusion}
\label{sec:org5af7f9c}
\chapter{Results}
\label{sec:org8bc2e36}
