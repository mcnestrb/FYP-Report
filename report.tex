...
\part{Background}
\label{sec:org68717ae}
\chapter{Decentralised Grid}
\label{sec:orge97417b}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:org851028f}
\section{Overview}
\label{sec:org657c943}
...
\chapter{Auctions}
\label{sec:org6e246a4}
\section{Overview}
\label{sec:orgae3ec30}
...
\chapter{Game Theory}
\label{sec:orgc1a8c31}
\section{Overview}
\label{sec:orgd6ed035}
...
\label{sec:org431ec94}
\section{Overview}
\label{sec:org6d02042}
...
\part{Implementation}
\label{sec:orgbb44c88}
\chapter{Design}
\label{sec:org1d7f08b}
\section{Games vs Auctions}
\label{sec:org7260abc}
...
\label{sec:orgc502725}
\subsection{EC Utility Function}
\label{sec:orgdfd6e30}
...
\chapter{Application}
\label{sec:org4d91d73}
\section{Python Twisted Framework}
\label{sec:org962a1d3}
...
that time.
\section{Client (EC)}
\label{sec:orge2a015d}
\subsection{Idle State}
\label{sec:orga33c327}
...
Solodov and Svaiter.
\section{Server (CPS)}
\label{sec:org7a36913}
\subsection{Idle State}
\label{sec:org1aec8e1}
...
\part{Conclusion}
\label{sec:org8846e0f}
\chapter{Results}
\label{sec:org1b80830}
