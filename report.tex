...
\part{Background}
\label{sec:orgad6376e}
\chapter{Decentralised Grid}
\label{sec:org0546a38}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:orgbecd586}
\section{Overview}
\label{sec:org26ea6cb}
...
\chapter{Auctions}
\label{sec:orgb9e8e3d}
\section{Overview}
\label{sec:orgeeac628}
...
\chapter{Game Theory}
\label{sec:orgfeddaff}
\section{Overview}
\label{sec:orgbf3facb}
...
\label{sec:org5e71429}
\section{Overview}
\label{sec:org5f32f9f}
...
\part{Implementation}
\label{sec:orgf5c4bb9}
\chapter{Design}
\label{sec:org7731c5a}
\section{Games vs Auctions}
\label{sec:orgf52a532}
...
\label{sec:org902ef9f}
\subsection{EC Utility Function}
\label{sec:org0a6d3f2}
...
\chapter{Application}
\label{sec:org42d688d}
\section{Python Twisted Framework}
\label{sec:orgbdebda4}
...
that time.
\section{Client (EC)}
\label{sec:org38b9db2}
\subsection{Idle State}
\label{sec:org63d1a87}
...
Solodov and Svaiter.
\section{Server (CPS)}
\label{sec:orgcb0b17e}
\subsection{Idle State}
\label{sec:org2d3257a}
...
\part{Conclusion}
\label{sec:orgde14a4f}
\chapter{Results}
\label{sec:org96da1ee}
