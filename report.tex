...
\part{Abstract}
\label{sec:orgba70f2a}

\part{Introduction}
\label{sec:org1d7a6e6}


\part{Background}
\label{sec:orgb30f0bf}
\chapter{Decentralised Grid}
\label{sec:org735ddc4}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:org5d73e9c}
\section{Overview}
\label{sec:org3e15978}
...
\label{sec:org31266fa}
\chapter{Auctions}
\label{sec:org2b265b0}
\chapter{Game Theory}
\label{sec:org64547da}
\section{Overview}
\label{sec:org20454f1}
...
\label{sec:orge3eae5f}
\section{Convex Optimisation}
\label{sec:orgbf62cc9}
\section{Hyperplane Projection}
\label{sec:org9cdf578}
\part{Implementation}
\label{sec:org5040665}
\chapter{Design}
\label{sec:org108e9c1}
\chapter{Framework}
\label{sec:org40e40d2}
\chapter{Processes}
\label{sec:org951b593}
\part{Conclusion}
\label{sec:org3ef1b69}
\chapter{Assessment}
\label{sec:orgde2b845}
\chapter{Future Work and Continuations}
\label{sec:orge926e77}
\printbibliography
\appendix
\end{document}