...
\part{Introduction}
\label{sec:orgd5cddbc}
\part{Background}
\label{sec:org7a7811f}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:org3de2471}
\section{Overview}
\label{sec:org660702e}
...
\chapter{Auctions}
\label{sec:org2fe3730}
\section{Overview}
\label{sec:orgc33a234}
...
\chapter{Game Theory}
\label{sec:org53c2317}
\section{Overview}
\label{sec:org163444c}
...
\label{sec:orgc209f66}
\section{Overview}
\label{sec:orgaf0f489}
...
\part{Implementation}
\label{sec:org001dd21}
\chapter{Design}
\label{sec:org8b186c5}
\section{Games vs Auctions}
\label{sec:org5c2eaab}
...
\label{sec:orgf5fe9c9}
\subsection{EC Utility Function}
\label{sec:orgee46761}
...
\chapter{Application}
\label{sec:org327017a}
\section{Python Twisted Framework}
\label{sec:org1e72e15}
...
that time.
\section{Client (EC)}
\label{sec:org8a337c9}
\subsection{Idle State}
\label{sec:org19380a4}
...
Solodov and Svaiter.
\section{Server (CPS)}
\label{sec:orgccbe60b}
\subsection{Idle State}
\label{sec:org7ae7d99}
