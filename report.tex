...
\part{Abstract}
\label{sec:org1b9e7e5}

\part{Introduction}
\label{sec:org6817e81}


\part{Background}
\label{sec:org60916f0}
\chapter{Decentralised Grid}
\label{sec:org8ef908e}
...
\label{sec:org45dabaa}
\chapter{Auctions}
\label{sec:org5e4f705}
\chapter{Game Theory}
\label{sec:org92dd2f1}
\section{Overview}
\label{sec:orgf91835e}
...
\label{sec:orge9e5ec5}
\section{Cournot and Stackelberg Games}
\label{sec:org562cb7b}
\chapter{Optimisation Techniques}
\label{sec:org48bf0bf}
\section{Convex Optimisation}
\label{sec:orge064502}
\section{Hyperplane Projection}
\label{sec:org27cac25}
\part{Implementation}
\label{sec:orgad1f7cd}
\chapter{Design}
\label{sec:orgd2a1466}
\chapter{Framework}
\label{sec:org0594e4a}
\chapter{Processes}
\label{sec:org446aa9d}
\part{Conclusion}
\label{sec:org3cdf970}
\chapter{Assessment}
\label{sec:orgbf76004}
\chapter{Future Work and Continuations}
\label{sec:org21f72b4}
\printbibliography
\appendix
\end{document}