...
\part{Background}
\label{sec:orgab506ea}
\chapter{Decentralised Grid}
\label{sec:org7cda1f4}
...
\end{figure}
\chapter{Smart Grid}
\label{sec:org409d0fa}
\section{Overview}
\label{sec:org0ef3367}
...
\chapter{Auctions}
\label{sec:org7f9d288}
\section{Overview}
\label{sec:org921e898}
...
\chapter{Game Theory}
\label{sec:org981463a}
\section{Overview}
\label{sec:org81899d9}
...
\label{sec:orgc3556c6}
\section{Overview}
\label{sec:org5d634cd}
...
\part{Implementation}
\label{sec:orga19cbb8}
\chapter{Design}
\label{sec:org803354a}
\section{Games vs Auctions}
\label{sec:orge225dce}
...
\label{sec:org994e4c5}
\subsection{EC Utility Function}
\label{sec:orgcdd4b50}
...
\chapter{Application}
\label{sec:org917ae2c}
\section{Python Twisted Framework}
\label{sec:orgb9e5009}
...
that time.
\section{Client (EC)}
\label{sec:org46a88ef}
\subsection{Idle State}
\label{sec:org02b7052}
...
Solodov and Svaiter.
\section{Server (CPS)}
\label{sec:org140ae40}
\subsection{Idle State}
\label{sec:orgadc2fd2}
...
\part{Conclusion}
\label{sec:org553fc53}
\chapter{Results}
\label{sec:org1a5961c}
